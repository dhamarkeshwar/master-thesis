...
\begin{definition}[Completeness]
  ...
  the honest verifier $V$ always accepts the honest prover $P$ for any $x\in L$.
\end{definition}
...
\begin{theorem}\cite{cryptoeprint:2023/1669}\label{th:PDL security}
  Let $(g,x_1,\dots,x_n,F_1,\dots,F_n)\in L_{PDL}$ be a statement with its corresponding witness being 
  $f\in\mathbb{Z}_q[X]_{\leq t}$ where $L_{PDL}$ is the language defined by the relation $R_{PDL}$. 
